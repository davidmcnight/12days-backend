defmodule TwelveDaysApiWeb.UserControllerTest do
  use TwelveDaysApiWeb.ConnCase

  alias TwelveDaysApi.Users

  @create_attrs %{email: "some email", field: "some field", first_name: "some first_name", last_name: "some last_name", latest_activity: ~N[2010-04-17 14:00:00], password_hash: "some password_hash"}
